...
#define PAD 0
  ...
  dslash_w_field_special(r,mmp,PLUS,EVEN, tage, is_startede);
  is_startede = 1;
  ...
  if(flag != 0) {
    ...
    dslash_w_field_special(t_dest,mmp,PLUS,ODD,tago,is_startedo);
    is_startedo = 1;
    dslash_w_field_special(mmp,mmp,PLUS,EVEN,tage,is_startede);
    is_startede = 1;
    FOREVENSITES(i,s) {
  ...
  for( N_iter = 0; N_iter < MinCG || (N_iter < MaxCG && RsdCG < qic->size_r); 
    ...
    /*   mmp = M(u)*p */
    dslash_w_field_special(p,mmp,PLUS,ODD,tago,is_startedo);
    is_startedo = 1;
    dslash_w_field_special(mmp,mmp,PLUS,EVEN,tage,is_startede);
    is_startede = 1;
    ...
    is_startedo = 1;
    dslash_w_field_special(sss,ttt,PLUS,EVEN,tage,is_startede);
    is_startede = 1;
