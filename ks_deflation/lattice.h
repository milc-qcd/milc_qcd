...
/* EigCG related global variables */
EXTERN  int Nvecs ; /* number of eigenvectors */
EXTERN  int active_parity ; /* parity used in eigenvalue calculation */
EXTERN  int nrhs; /*total number of RHS */
EXTERN  int inc_nrhs; /*maximum number of RHS in the incremental stage */
EXTERN  Real restart_tol ; /* Tolerance for initCG restarts */
/*******/
