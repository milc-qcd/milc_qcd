...
# in numeric fields when they exceed a tolerance.  A third, error
# tolerance file specifies the tolerance for deviations.  The error
# tolerance file replaces the values with the allowable absolute error.
