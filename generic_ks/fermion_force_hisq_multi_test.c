					   ...
					   fermion_links_t *fl)
{
...
#if 1
  qudaHisqForce(MILC_PRECISION, n_order_naik_total, n_orders_naik_current, coeff, ap->p2.act_path_coeff.one_link, (void**)multi_x,
  ...
  void *oprod[3] = {staple_oprod, one_link_oprod, three_link_oprod};
  qudaComputeOprod(MILC_PRECISION, n_order_naik_total, n_orders_naik_current, coeff, ap->p2.act_path_coeff.one_link, (void**)multi_x, oprod);
  
  qudaHisqForceOld(MILC_PRECISION, level2_coeff, fat7_coeff, (const void* const*)staple_oprod, (const void* const*)one_link_oprod, 
                   (const void* const*)three_link_oprod, W_unitlink, V_link, U_link, momentum); 
