                        ...
                        int init )
{
  ...
  GRID_ColorVector ** grid_eigVec = (GRID_ColorVector **) malloc( Nvecs * sizeof( GRID_ColorVector * ) );
  for( ii=0; ii<Nvecs; ii+=1 )
  {
    *(grid_eigVec+ii) = GRID_create_V_from_vec( *(eigVec+ii), parity, grid_full, grid_rb );
  }
  ...
  {
    GRID_extract_V_to_vec( *(eigVec+ii), *(grid_eigVec+ii), parity );    
  }
