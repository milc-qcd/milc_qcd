		   ...
		   field_offset dest, int timing)
{
  ...
  case FRESH:     /* zero initial guess */
    FORALLSITES(i,s) fclearvec( (fsu3_vector *)F_PT(s,dest));
    break;
  case RELOAD_ASCII:
...
/************* cribbed from  clearvec.c  (in su3.a) *********************
*									*
*  void fclearvec( fsu3_vector *vec )					*
