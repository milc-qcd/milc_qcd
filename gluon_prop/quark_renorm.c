...
int quark_renorm( void ) {
  ...
  /* Here, instead of 0, we should use the Naik epsilon index appropriate to each fermion */
    fn = get_fm_links(fn_links, 0); /* Must be the same for all masses in this set */
