...
int main (int argc, char* argv[]) {
  ...
  printf("#define ACTION_ORDER_X %d // order for fermion action factor X\n",order2);

  work( y1,4,m1,  y2,4,m2,  y3,4,m3,  y4,4,m4, order1, lambda_low, lambda_high, precision,
    "OMIT", "MD" );
  work( y1,8,m1,  y2,8,m2,  y3,8,m3,  y4,8,m4, order2, lambda_low, lambda_high, precision,
    "GR", "FA" );
}
