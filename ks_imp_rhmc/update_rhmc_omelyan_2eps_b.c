...
Three Omelyan steps for gauge and factor_two force, factor_one force at
middle of interval.
...
Real rsqmin_save;
   ...
   for(i=0;i<MAX_RAT_ORDER;i++) multi_x[i]=(su3_vector *)malloc( sizeof(su3_vector)*sites_on_node );
	...
	rsqmin_save=rsqmin; rsqmin *= CG1_ERRORSTRETCH; // Try less accurate CG for this one
	eo_fermion_force_rhmc( alg_flag, 3.0*epsilon, MOLDYN_ORDER_1, mass1, A_MD_1,
