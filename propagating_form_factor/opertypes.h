...
/* Modifications
   ...
   C. DeTar 11/18/98 Added gamma_0 projections of source
   */
...
static char name_3pt[ HALF_NO_THREEPT_OPERS ][ MAXNAME ] = {
  ...
  "RHOX_SIGMA_ZX" ,                /* and B -> rho + leptons */
  "RHOX_SIGMA_XT" ,
  "RHOX_SIGMA_YZ" ,
  "RHOX_SIGMA_YT" ,
  "RHOX_SIGMA_ZT" ,
...
/** The number of extra copies of the correlators because of the 
    derivatives**/
#define TOTAL_COPIES 3 
static int three_pt_copies = TOTAL_COPIES ; 
static int two_pt_copies =   TOTAL_COPIES  ; 
#undef TOTAL_COPIES
