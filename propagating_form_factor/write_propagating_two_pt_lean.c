/******************* write_propagating_two_point_lean.c ******************/ 
/* MIMD version 6 */
...
/** $Header: /lqcdproj/detar/cvsroot/milc_qcd/propagating_form_factor/write_propagating_two_pt_lean.c,v 1.1 2005/02/23 00:05:54 detar Exp $ ***/
...
#undef HEADER_DIM_WRITE_CORR
  ...
  for(i = 0 ; i < 3 ; ++i)
    for(p = 0 ; p < no_k_values ; ++p )
      q_momstore_local[p][i] =  (int32type)k_momstore[p][i] ; 
