...
do
  ...
  do
    ...
    tar -cf met${r}${sp}${zk}.tar me.bvtp${r}_p${p}*sp${sp}*zk${zk}*
    tar -cf mex${r}${sp}${zk}.tar me.bvxp${r}_p${p}*sp${sp}*zk${zk}*
    tar -cf mey${r}${sp}${zk}.tar me.bvyp${r}_p${p}*sp${sp}*zk${zk}*
    tar -cf mez${r}${sp}${zk}.tar me.bvzp${r}_p${p}*sp${sp}*zk${zk}*
