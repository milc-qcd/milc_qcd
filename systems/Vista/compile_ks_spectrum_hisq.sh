...
COMPILER="gnu" \
OPT="-O3 -Ofast -g" \
LDFLAGS="-g -L/home1/apps/nvidia/Linux_aarch64/24.9/cuda/lib64 -lcudart -L/home1/apps/nvidia/Linux_aarch64/24.9/math_libs/lib64 -lcublas -lcufft -L/home1/apps/nvidia/Linux_aarch64/24.9/cuda/lib64/stubs -lnvidia-ml" \
