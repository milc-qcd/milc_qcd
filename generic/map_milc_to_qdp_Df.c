...
void \
set_D_##T##_from_site(QDP_D_##TYPE *dest, field_offset src) \
{ \
  int i; \
  site *s; \
  QLA_F_##TYPE t; \
...
void \
set_site_from_D_##T(field_offset dest, QDP_D_##TYPE *src) \
{ \
  int i; \
  site *s; \
  QLA_F_##TYPE t; \
...
void \
set_D_##T##_from_field(QDP_D_##TYPE *dest, MILCTYPE *src) \
{ \
  int i; \
  site *s; \
  QLA_F_##TYPE t; \
...
void \
set4_D_##T##_from_site(QDP_D_##TYPE *dest[], field_offset src) \
{ \
  int i, dir; \
  site *s; \
  QLA_F_##TYPE t; \
...
void \
set_field_from_D_##T(MILCTYPE *dest, QDP_D_##TYPE *src) \
{ \
  int i; \
  site *s; \
  QLA_F_##TYPE t; \
...
void \
set4_D_##T##_from_field(QDP_D_##TYPE *dest[], MILCTYPE *src) \
{ \
  int i, dir; \
  site *s; \
  QLA_F_##TYPE t; \
...
void \
set4_field_from_D_##T(MILCTYPE *dest, QDP_D_##TYPE *src[]) \
{ \
  int i, dir; \
  site *s; \
  QLA_F_##TYPE t; \
