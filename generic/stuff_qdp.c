...
void \
set_##T##_from_field(QDP_##TYPE *dest, field_offset src) \
{ \
  int i; \
  site *s; \
  QLA_##TYPE *temp; \
...
void \
set_field_from_##T(field_offset dest, QDP_##TYPE *src) \
{ \
  int i; \
  site *s; \
  QLA_##TYPE *temp; \
...
#define make_set_qdp_from_temp(T, TYPE, MILCTYPE) \
void \
set_##T##_from_temp(QDP_##TYPE *dest, MILCTYPE *src) \
{ \
  int i; \
  site *s; \
  QLA_##TYPE *temp; \
...
#define make_set_temp_from_qdp(T, TYPE, MILCTYPE) \
void \
set_temp_from_##T(MILCTYPE *dest, QDP_##TYPE *src) \
{ \
  int i; \
  site *s; \
  QLA_##TYPE *temp; \
...
#define make_set4_qdp_from_temp(T, TYPE, MILCTYPE) \
void \
set4_##T##_from_temp(QDP_##TYPE *dest[], MILCTYPE *src) \
{ \
  int i, dir; \
  site *s; \
  QLA_##TYPE *temp; \
...
copy_types(make_set_qdp_from_temp);

copy_types(make_set_temp_from_qdp);

copy_types(make_set4_qdp_from_temp);
