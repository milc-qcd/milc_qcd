...
#define MAX(a,b) ( (a)>(b) ? (a) : (b) )
  ...
  else if( strcmp("symanzik", qss_op->flow_type) == 0 ) {
  ...
  /* Setup QUDA invert params */
  QudaInvertParam invParams = newQudaInvertParam();
  invParams.dirac_order = QUDA_DIRAC_ORDER;
  invParams.dslash_type = QUDA_ASQTAD_DSLASH;
