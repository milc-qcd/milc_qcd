...
mult_su3_an:
	...
	xorpd	xmm0,[negate]		; xmm0 = b00i,-b00r	<_sse_sgn4>
	xorpd	xmm1,[negate]		; xmm1 = b10i,-b10r	<_sse_sgn4>
	xorpd	xmm2,[negate]		; xmm2 = b20i,-b20r	<_sse_sgn4>
	...
	unpcklpd xmm6,xmm6		; xmm6 = a00i,a00i
	unpcklpd xmm7,xmm7		; xmm7 = a11i,a11i
	xorpd	xmm0,[negate]		; xmm0 = b01i,-b01r	<_sse_sgn4>
	xorpd	xmm1,[negate]		; xmm1 = b11i,-b11r	<_sse_sgn4>
	xorpd	xmm2,[negate]		; xmm2 = b21i,-b21r	<_sse_sgn4>
	...
	unpcklpd xmm6,xmm6		; xmm6 = a00i,a00i
	unpcklpd xmm7,xmm7		; xmm7 = a11i,a11i
	xorpd	xmm0,[negate]		; xmm0 = b02i,-b02r	<_sse_sgn4>
	xorpd	xmm1,[negate]		; xmm1 = b12i,-b12r	<_sse_sgn4>
	xorpd	xmm2,[negate]		; xmm2 = b22i,-b22r	<_sse_sgn4>
