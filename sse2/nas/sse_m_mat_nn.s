...
mult_su3_nn:
	...
	movupd	xmm1,[ebx+48]		; xmm1 = b10r,b10i <(bb)->e[1][0]>
	movupd	xmm2,[ebx+96]		; xmm2 = b20r,b20i <(bb)->e[2][0]>
	;
	; REAL	Part I
	;
	...
	xorpd	xmm0,[negate]		; xmm0 = -b00i,b00r	<_sse_sgn2>
	xorpd	xmm1,[negate]		; xmm1 = -b10i,b10r	<_sse_sgn2>
	xorpd	xmm2,[negate]		; xmm2 = -b20i,b20r	<_sse_sgn2>
	...
	; REAL	Part II
	;
	movupd	xmm0,[ebx+16]		; xmm0 = b01r,b01i <(bb)->e[0][1]>
	movupd	xmm1,[ebx+64]		; xmm1 = b11r,b11i <(bb)->e[1][1]>
	movupd	xmm2,[ebx+112]		; xmm2 = b21r,b21i <(bb)->e[2][1]>
	...
	unpcklpd xmm6,xmm6		; xmm6 = a00i,a00i
	unpcklpd xmm7,xmm7		; xmm7 = a11i,a11i
	xorpd	xmm0,[negate]		; xmm0 = -b01i,b01r	<_sse_sgn2>
	xorpd	xmm1,[negate]		; xmm1 = -b11i,b11r	<_sse_sgn2>
	xorpd	xmm2,[negate]		; xmm2 = -b21i,b21r	<_sse_sgn2>
	...
	; REAL	Part III
	;
	movupd	xmm0,[ebx+32]		; xmm0 = b02r,b02i <(bb)->e[0][2]>
	movupd	xmm1,[ebx+80]		; xmm1 = b12r,b12i <(bb)->e[1][2]>
	...
	unpcklpd xmm6,xmm6		; xmm6 = a00i,a00i
	unpcklpd xmm7,xmm7		; xmm7 = a11i,a11i
	xorpd	xmm0,[negate]		; xmm0 = -b02i,b02r	<_sse_sgn2>
	xorpd	xmm1,[negate]		; xmm1 = -b12i,b12r	<_sse_sgn2>
	xorpd	xmm2,[negate]		; xmm2 = -b22i,b22r	<_sse_sgn2>
