...
mult_adj_su3_mat_vec_4dir:
	...
	movupd	[ecx],xmm3		;	<cc[0].c[0]>
	movupd	[ecx+16],xmm4		;	<cc[0].c[1]>
	movupd	[ecx+32],xmm5		;	<cc[0].c[2]>
	;
	...
	addpd 	xmm5,xmm6		; xmm5 = a02r*b0r + a12r*b1r + a22r*b2r + a22i*b2i + a02i*b0i + a12i*b1i , a02r*b0i + a12r*b1i + a22r*b2i - a22i*b2r - a02i*b0r - a12i*b1r
        	                        ;        a02r*b0r + a02i*b0i + a12r*b1r + a12i*b1i + a22r*b2r + a22i*b2i , a02r*b0i - a02i*b0r + a12r*b1i - a12i*b1r + a22r*b2i - a22i*b2r 
	movupd	[ecx+48],xmm3		;	<cc[1].c[0]>
	movupd	[ecx+64],xmm4		;	<cc[1].c[1]>
	movupd	[ecx+80],xmm5		;	<cc[1].c[2]>
	;
	; restore original su3_vector b values
	;
	movupd  xmm0,[ebx]		; <(bb)->c[0]>
	...
	addpd 	xmm5,xmm6		; xmm5 = a02r*b0r + a12r*b1r + a22r*b2r + a22i*b2i + a02i*b0i + a12i*b1i , a02r*b0i + a12r*b1i + a22r*b2i - a22i*b2r - a02i*b0r - a12i*b1r
        	                        ;        a02r*b0r + a02i*b0i + a12r*b1r + a12i*b1i + a22r*b2r + a22i*b2i , a02r*b0i - a02i*b0r + a12r*b1i - a12i*b1r + a22r*b2i - a22i*b2r 
	movupd	[ecx+96],xmm3		;	<cc[2].c[0]>
	movupd	[ecx+112],xmm4		;	<cc[2].c[1]>
	movupd	[ecx+128],xmm5		;	<cc[2].c[2]>
	;
	; restore original su3_vector b values
	;
	movupd  xmm0,[ebx]		; <(bb)->c[0]>
	...
	addpd 	xmm5,xmm6		; xmm5 = a02r*b0r + a12r*b1r + a22r*b2r + a22i*b2i + a02i*b0i + a12i*b1i , a02r*b0i + a12r*b1i + a22r*b2i - a22i*b2r - a02i*b0r - a12i*b1r
        	                        ;        a02r*b0r + a02i*b0i + a12r*b1r + a12i*b1i + a22r*b2r + a22i*b2i , a02r*b0i - a02i*b0r + a12r*b1i - a12i*b1r + a22r*b2i - a22i*b2r 
	movupd	[ecx+144],xmm3		;	<cc[3].c[0]>
	movupd	[ecx+160],xmm4		;	<cc[3].c[1]>
	movupd	[ecx+176],xmm5		;	<cc[3].c[2]>
	;
here:	pop	ecx
	pop	ebx
	pop	eax
