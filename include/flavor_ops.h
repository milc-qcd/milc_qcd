...
void mult_pioni5_field( int fdir, int r0[], const su3_vector * const src,
			su3_vector *dest, const su3_matrix * const links );
void mult_pionij_field( int fdir, int r0[], const su3_vector * const src,
			su3_vector *dest, const su3_matrix * const links );
void mult_pioni_field( int fdir, int r0[], const su3_vector * const src,
		       su3_vector *dest, const su3_matrix * const links );
void mult_pioni0_field( int fdir, int r0[], const su3_vector * const src,
			su3_vector *dest, const su3_matrix * const links );
void mult_pions_field(int r0[], const su3_vector * const src,
		      su3_vector *dest, const su3_matrix * const links );
void mult_pion0_field(int r0[], const su3_vector * const src,
		      su3_vector *dest, const su3_matrix * const links );
...
void mult_rhos_field( int fdir,  int r0[], const su3_vector * const src,
		      su3_vector *dest, const su3_matrix * const links );
void mult_rho0_field( int fdir,  int r0[], const su3_vector * const src,
		      su3_vector *dest, const su3_matrix * const links );
