...
void mult_pioni5_field( int fdir, int r0[], su3_vector *src, su3_vector *dest );
void mult_pionij_field( int fdir, int r0[], su3_vector *src, su3_vector *dest );
void mult_pioni_field( int fdir, int r0[], su3_vector *src, su3_vector *dest );
void mult_pioni0_field( int fdir, int r0[], su3_vector *src, su3_vector *dest );
void mult_pions_field(int r0[], su3_vector *src, su3_vector *dest );
void mult_pion0_field(int r0[], su3_vector *src, su3_vector *dest );
...
void mult_rhos_field( int fdir,  int r0[], su3_vector *src, su3_vector *dest );
void mult_rho0_field( int fdir,  int r0[], su3_vector *src, su3_vector *dest );
