...
// C <- A_adjoint*B
// file m_mat_an.m4, i860 assembler version of m_mat_an.c
//
// Register usage:
// r19 = increment = -1
// r20 = loop counter
...
LOOP:
	...
	d.m12apm.ss a10i,b1i,f0;	fld.d	48(B),b2
	d.m12apm.ss a10i,b1r,f0;	adds 8,B,B	// next column
...
.align 8
	d.m12apm.ss a02r,b0r,f0
	d.m12asm.ss a02r,b0i,f0
	d.m12apm.ss a01r,b0i,f0;	nop
...
.align 8
	...
	d.m12asm.ss a00r,b0i,f0;	fld.d 24(B),b1
	d.m12asm.ss a01r,b0r,f0;	adds 8,C,C	// next column
	...
	// the remaining code is executed only for the third column of C
	d.m12apm.ss a00i,b0i,f0;	fld.d 	24(A),a10
	d.m12apm.ss a00i,b0r,f0;	nop
	d.m12apm.ss a01i,b0i,f0;	fld.d	32(A),a11
	// first column of A
