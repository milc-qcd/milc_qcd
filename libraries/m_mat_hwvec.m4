// mult_su3_mat_hwvec( su3_matrix *a, half_wilson_vector *b,
//    half_wilson_vector *c)
// c <- a*b
// file m_mat_hwvec.m4, i860 assembler version of m_mat_hwvec.c
//
// Register usage:
// f8,f9   = b[0][column]
// f10,f11 = b[1][column]
...
.align 8
	...
	d.m12apm.ss a00r,b0i,f0;	fld.d 32(B),b1
	...
	d.m12apm.ss a01r,b1i,f0;	fld.d	16(A),a02
	d.m12asm.ss a11r,b1r,f0;	nop
	d.m12apm.ss a01i,b1i,f0;	fld.d	40(B),b2
	d.m12apm.ss a01i,b1r,f0;	nop
	d.m12apm.ss a11i,b1i,f0;	fld.d	40(A),a12
	// second column of A
	d.m12asm.ss a02r,b2r,f0;	nop
...
.align 8
	...
	// Now enter zeroes into adder pipe, while results from first
	// half are coming out.
	d.pfadd.ss	f0,f0,c0r;	fst.d	c1,8(C)
